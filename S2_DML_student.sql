...
SELECT inschrijvingen.cursus, inschrijvingen.begindatum
FROM medewerkers
...
WHERE afdelingen.locatie = 'UTRECHT' OR afdelingen.locatie = 'MAASTRICHT'
...
INSERT INTO "medewerkers" ("mnr", "naam", "voorl", "functie", "chef", "gbdatum", "maandsal") VALUES ('8100', 'Stagairman', 'Sgr', 'STAGAIR', '7876', '2021-09-13', '0');
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO "uitvoeringen" ("cursus", "begindatum", "docent", "locatie") VALUES ('D&P', '2021-09-13', '7499', 'LEERDAM');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO "uitvoeringen" ("cursus", "begindatum", "docent", "locatie") VALUES ('D&P', '2021-09-14', '7499', 'LEERDAM');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO "inschrijvingen" ("cursist", "cursus", "begindatum") VALUES ('7698', 'D&P', '2021-09-13');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO "inschrijvingen" ("cursist", "cursus", "begindatum") VALUES ('7521', 'D&P', '2021-09-13');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO "inschrijvingen" ("cursist", "cursus", "begindatum") VALUES ('7839', 'D&P', '2021-09-14');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
--Alders lukt niet omdat hier nog een foreign key aan vast zit, dan zal je eerst de data aan hem gelinked moeten verwijderen
...
INSERT INTO "afdelingen" ("naam", "locatie") VALUES ('FINANCIEN', 'LEERDAM');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO "medewerkers" ("mnr", "naam", "voorl", "functie", "chef", "gbdatum", "maandsal", "afd") VALUES ('8002', 'MEDENBACH', 'V', 'MANAGER', '7839', '2021-09-13', '1300', '70');
UPDATE "afdelingen" SET "hoofd"='8002' WHERE  "anr"=70;
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
